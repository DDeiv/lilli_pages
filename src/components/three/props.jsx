...
const GRAY_LIGHT = '#d9d4c8' // caps, lids, labels
const GRAY_DARK = '#3a3a38'  // dark details
  ...
  return (
    <group>
      ...
      <mesh position={[0, 0.475, 0]}>
        ...
        <meshStandardMaterial color={GRAY_LIGHT} />
        <Lines />
      </mesh>
      {/* label band */}
      <mesh position={[0, 0.475, 0]}>
  ...
  return (
    <group>
      ...
      <mesh position={[0, 1.06, 0]}>
        ...
        <meshStandardMaterial color={GRAY_DARK} />
        <Lines />
      </mesh>
    </group>
  )
...
export function PropRow({ groupRef, position, type = 'can', color = '#d9b23c', seed = 0, density = 1 }) {
  ...
  const layout = useMemo(() => {
    ...
    const baseY = -PRODUCT_STRIP_SIZE.y / 2
  ...
  return (
    <group position={position} rotation={rotation}>
      ...
      <mesh position={[0, 0.5, -0.065]} rotation={[-0.35, 0, 0]}>
        ...
        <meshStandardMaterial color="#8fd4c2" emissive="#8fd4c2" emissiveIntensity={0.35} />
      </mesh>
      {/* keypad */}
      ...
      {[0, 1, 2, 3].map((i) => (
        <group key={i} position={[0, 0.11 + i * 0.16, 0]} rotation={[0, (seeded(i * 17) - 0.5) * 0.2, 0]}>
          <mesh>
            ...
            <meshStandardMaterial color={i % 2 === 0 ? SLUDGE.productAccents[1] : SLUDGE.productAccents[0]} />
            <Lines />
          </mesh>
          {/* handle */}
          <mesh position={[0, 0.14, 0]}>
  ...
  return (
    <group position={position}>
      <mesh>
        ...
        <meshStandardMaterial color={GRAY_LIGHT} emissive="#fff6d8" emissiveIntensity={0.9} />
      </mesh>
      {/* hanging rods */}
