...
export function CameraFPS() {
  ...
  useEffect(() => {
    const onWheel = (e) => {
      // Don't scroll if frozen or camera is locked
      if (scrollFrozen.current || cameraLocked.current || storeCameraLocked) {
        return;
      }
  ...
  }, [camera, savedCameraPosition, savedCameraRotation, setCameraLocked]);
